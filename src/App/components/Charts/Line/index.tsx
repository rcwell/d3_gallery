...
interface LineChartProps extends SVGProps, ChartProps, VerticalChartProps {
...
export const LineChart = (props: LineChartProps) => {
    ...
    // const [scalers, setScalers] = useState<Scalers>(Object)
    ...
    const drawChartHover = React.useCallback((container: Selection<SVGGElement, unknown, null, undefined>) => {
        ...
        const bandwidth = innerSize.width / (isTimeSeries ? _seriesData : (xaxis.categories || [])).length;
        ...
        const indexGroup = indexGroupData
            ...
            .attr("x", (d: any, i) => isTimeSeries ? i * bandwidth : (xScale(d) || 0) - (bandwidth / 2))
            .attr('y', 0)
    ...
    }, [svgRef, margin, drawAxis, drawLinePath, drawLegends, drawTitle, xScale, drawChartHover, isTimeSeries]);
